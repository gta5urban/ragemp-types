...
declare interface PedMpBase extends EntityMp {
	...
	getNearbyPeds(numPeds: number, ignoreType: number): number[] | null;
	getNearbyVehicles(numVehicles: number): number[] | null;
	...
	/**
	 * Returns nearby objects.
	 */
	getNearbyObjects(numObjects: number, maxDistance: number, ignoreDamaged: boolean): NearbyObjectInfo[] | null;
}
